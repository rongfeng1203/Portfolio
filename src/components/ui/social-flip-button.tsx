...
const defaultItems: SocialItem[] = [
    { letter: "C", icon: <span aria-hidden="true">@</span>, label: "Contact", href: "#" },
    { letter: "O", icon: <span aria-hidden="true">@</span>, label: "Contact", href: "#" },
    { letter: "N", icon: <span aria-hidden="true">@</span>, label: "Contact", href: "#" },
    { letter: "T", icon: <span aria-hidden="true">@</span>, label: "Contact", href: "#" },
    { letter: "A", icon: <span aria-hidden="true">@</span>, label: "Contact", href: "#" },
    { letter: "C", icon: <span aria-hidden="true">@</span>, label: "Contact", href: "#" },
    { letter: "T", icon: <span aria-hidden="true">@</span>, label: "Contact", href: "#" },
];
...
const SocialFlipNode = ({
    ...
    return (
        ...
        >
            <AnimatePresence>
                {showTooltips && isHovered && tooltipIndex === index && (
                    <motion.div
